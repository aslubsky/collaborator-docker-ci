...
RUN apt-get install -y nodejs php7.3-cli php7.3-mysql php7.3-xml php7.3-curl php7.3-gd php7.3-intl php7.3-zip php7.3-mbstring php7.3-sqlite php7.3-ldap php7.3-redis php7.3-dev
